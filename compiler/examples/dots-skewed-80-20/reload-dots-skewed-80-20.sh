...
for i in {81..100}; do
    ...
    $PSQL $PGCONN -q -t -c "insert into dots_skewed_80_20 (id,w,h, citus_distribution_id) select id, (random()*1000000)::bigint, (random()*1000000)::bigint, (random()*2147483648*2.0 - 2147483648)::int from generate_series(1,10000*$SCALE) id;"
done
